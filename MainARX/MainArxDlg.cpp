...
//-----------------------------------------------------------------------------
MainArxDlg::MainArxDlg (CWnd *pParent /*=NULL*/, HINSTANCE hInstance /*=NULL*/) : CAcUiDialog (MainArxDlg::IDD, pParent, hInstance) {
}
...
{
	CFileDialog fileDlg(FALSE, L".txt", L"default.txt",
